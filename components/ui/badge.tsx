  ...
  'inline-flex items-center rounded-md px-2.5 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        premium:
          'bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-400 text-black border-transparent hover:from-amber-600 hover:via-yellow-600 hover:to-amber-500',
      },
    },
    defaultVariants: {
      variant: 'default',
